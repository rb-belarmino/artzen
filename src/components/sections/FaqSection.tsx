      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-4 mb-14">
          <Badge variant="gold" className="px-4 py-1.5 gap-2">
            ...
            <span className="uppercase text-[11px] font-semibold tracking-wider text-[#8C6A2E]">
          ...
          <p className="fluid-lead text-[#5A524C] font-normal">
            Tudo o que você precisa saber sobre o processo de orçamento,
            fabricação, montagem e garantias de fábrica.
          </p>
        </div>
        ...
        <Accordion type="single" collapsible className="w-full space-y-4">
          {FAQ_DATA.map(item => (
            <AccordionItem key={item.id} value={item.id}>
              ...
              <AccordionContent>
                <p className="text-[#403A34] text-sm sm:text-base leading-relaxed">
                  {item.answer}
                </p>
              </AccordionContent>
            </AccordionItem>
        ...
        <div className="mt-12 p-8 rounded-3xl luxury-card-light flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-[#736B63] font-normal mt-0.5">
                Nossa equipe de atendimento responde em poucos minutos no
                WhatsApp.
              </p>
            </div>
          </div>
          ...
          <Button
            ...
            variant="default"
            size="default"
            className="w-full sm:w-auto shrink-0 shadow-lg hover:scale-102 transition-transform"
          >
            <a
              href={buildWhatsAppUrl({
                customMessage:
                  'Olá! Tenho uma dúvida sobre projeto de móveis planejados que não encontrei no site.'
              })}
              target="_blank"
